...
SUM(fu.total_revenue_before_promotion),
SUM(fu.total_revenue_after_promotion)
...
GROUP BY Category ; #To run the query, select line 71 to 100
...
ORDER BY 2 DESC   
LIMIT 5 #To run the query select from line 104 to line 139
